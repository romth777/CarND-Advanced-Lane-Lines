...
[image3]: ./output_images/grad_test1.png "Binary Example"
[image4]: ./output_images/highlighted_test1.png "Warp Example"
[image5]: ./output_images/polyfitted_test1.png "Fit Visual"
[image6]: ./output_images/output_test1.jpg "Output"
[video1]: ./output_images/result_project_video.mp4 "Video"
...
dst = np.float32([[self.img_size[0], 0], [0, 0], [0, self.img_size[1]], [self.img_size[0], self.img_size[1]]])
```
...
Here's a [link to my video result](./output_images/resutl_project_video.mp4)
